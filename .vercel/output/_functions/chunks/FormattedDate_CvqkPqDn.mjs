import { c as createComponent, a as createAstro, d as addAttribute, v as renderScript, g as renderTemplate, r as renderComponent, m as maybeRenderHead, w as spreadAttributes, F as Fragment, u as unescapeHTML } from './astro/server_BAAoksWn.mjs';
/* empty css                         */
...
const $$ClientRouter = createComponent(($$result, $$props, $$slots) => {
  ...
  return renderTemplate`<meta name="astro-view-transitions-enabled" content="true"><meta name="astro-view-transitions-fallback"${addAttribute(fallback, "content")}>${renderScript($$result, "/home/joseph/workspace/nico/sorollaportfolio/node_modules/.pnpm/astro@5.5.5_@netlify+blobs@8.1.2_@types+node@22.13.13_jiti@2.4.2_lightningcss@1.29.2_rollup@4_etnhjkyxwq54eljtlnzithdsby/node_modules/astro/components/ClientRouter.astro?astro&type=script&index=0&lang.ts")}`;
}, "/home/joseph/workspace/nico/sorollaportfolio/node_modules/.pnpm/astro@5.5.5_@netlify+blobs@8.1.2_@types+node@22.13.13_jiti@2.4.2_lightningcss@1.29.2_rollup@4_etnhjkyxwq54eljtlnzithdsby/node_modules/astro/components/ClientRouter.astro", void 0);
...
}, "/home/joseph/workspace/nico/sorollaportfolio/src/components/BaseHead.astro", void 0);
...
}, "/home/joseph/workspace/nico/sorollaportfolio/src/components/HeaderLink.astro", void 0);
...
}, "/home/joseph/workspace/nico/sorollaportfolio/node_modules/.pnpm/astro-icon@1.1.5/node_modules/astro-icon/components/Icon.astro", void 0);
...
&copy; ${today.getFullYear()} Nicol Silva.
<div class="flex items-center gap-6 text-5xl"> <a href="https://www.instagram.com/nicol.s.art?igsh=MTl0dmp0OGUwNzNhYw==" target="_blank" class="py-1 pl-3 rounded-md border-1 border-black bg-ppink shadow-card hover:shadow-hover transition"> ${renderComponent($$result, "Icon", $$Icon, { "name": "web" })} </a> <a href="https://github.com/JosephSC0121" target="_blank" class="border-1 p-1 border-black rounded-full bg-pblue shadow-card hover:shadow-hover transition"> ${renderComponent($$result, "Icon", $$Icon, { "name": "github" })} </a> <a href="https://www.linkedin.com/in/nicol-silva-rodriguez-b39926348/" target="_blank" class="border-1 p-1 border-black rounded-full bg-pgreen shadow-card hover:shadow-hover transition"> ${renderComponent($$result, "Icon", $$Icon, { "name": "linkedin" })} </a> </div> </footer>`;
}, "/home/joseph/workspace/nico/sorollaportfolio/src/components/Footer.astro", void 0);
...
}, "/home/joseph/workspace/nico/sorollaportfolio/src/components/FormattedDate.astro", void 0);
